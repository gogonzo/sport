...
# About
Package contains functions calculating ratings for two-player or multi-player matchups. Methods included in package are able to estimate players ratings, estimates evolution in time and to predict output of any challange. 
