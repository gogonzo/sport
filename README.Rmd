...
glicko  <- glicko_run(  formula = rank|id ~ rider, data = gpheats[1:1002,] )
glicko2 <- glicko2_run( formula = rank|id ~ rider, data = gpheats[1:1002,] )
bbt     <- bbt_run(     formula = rank|id~rider  , data = gpheats[1:1002,] )
dbl     <- dbl_run(     formula = rank|id~rider+field  , data = gpheats[1:1002,] )
```
