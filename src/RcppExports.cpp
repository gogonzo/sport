...
// EKF
List EKF(arma::vec x, arma::mat F, arma::mat B, arma::vec u, arma::vec z, arma::mat H);
RcppExport SEXP sport_EKF(SEXP xSEXP, SEXP FSEXP, SEXP BSEXP, SEXP uSEXP, SEXP zSEXP, SEXP HSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(EKF(x, F, B, u, z, H));
    return rcpp_result_gen;
END_RCPP
}
// glicko
