...
Outcome probability function is based on [Bradley-Terry model](https://en.wikipedia.org/wiki/Bradley%E2%80%93Terry_model) 
...
model <- glicko2_run(rank | id ~ name, data = data, r = r, rd = rd)
print(model$final_r)
...
```{r}
glicko2 <- glicko2_run(rank | id ~ rider, data, lambda = "lambda")
```
