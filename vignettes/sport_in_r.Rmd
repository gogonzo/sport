...
model predictions with observed probabilities. More precise summarization are  
...
To specify weight $\omaga_i$  one needs to create additional column in input 
...
knowledge about higher risk of event or undertainty of specific player 
