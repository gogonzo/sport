...
To visualize top n ratings with their 95% confidence interval one can use dedicated `plot.rating` function. For "bdl" method top coeficients are presented not necessarily ratings.  
```{r}
plot(glicko)
plot(glicko, players = c("Tony Rickardsson","Hans Nielsen"))
```
